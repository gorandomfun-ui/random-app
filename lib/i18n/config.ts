...
// Les langues que tu gères dans /lib/i18n/dictionaries/{fr,en,de,jp,es}.ts
export type Language = 'fr' | 'en' | 'de' | 'jp' | 'es'
...
/**
 * Charge dynamiquement le dictionnaire {fr|en|de|jp|es}.ts
