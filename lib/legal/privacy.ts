...
export const privacyPolicyCopy: Record<'en' | 'fr' | 'de' | 'es' | 'jp', PrivacyCopy> = {
  ...
  en: {
    ...
    sections: [
      ...
      { id: 'do-not-sell', title: '8. Contact and rights', body: 'Depending on applicable law, you may request access, correction, deletion, restriction or objection concerning your data, and withdraw permission at any time. Email gorandomfun@gmail.com. You may also contact the competent data protection authority.' },
  ...
  de: {
    ...
    sections: [
      ...
      { id: 'do-not-sell', title: '8. Kontakt und Rechte', body: 'Je nach anwendbarem Recht können Sie Auskunft, Berichtigung, Löschung, Einschränkung oder Widerspruch verlangen und eine Erlaubnis jederzeit widerrufen. Schreiben Sie an gorandomfun@gmail.com. Sie können sich auch an die zuständige Datenschutzbehörde wenden.' },
  ...
  es: {
    ...
    sections: [
      ...
      { id: 'do-not-sell', title: '8. Contacto y derechos', body: 'Según la legislación aplicable, puedes solicitar acceso, rectificación, supresión, limitación u oposición, y retirar un permiso en cualquier momento. Escribe a gorandomfun@gmail.com. También puedes acudir a la autoridad de protección de datos competente.' },
  ...
  jp: {
    ...
    sections: [
      ...
      { id: 'do-not-sell', title: '8. お問い合わせと権利', body: '適用される法律に応じて、データへのアクセス、訂正、削除、処理制限、異議申立てを求め、許可をいつでも撤回できます。gorandomfun@gmail.comまでご連絡ください。管轄のデータ保護機関に申し立てることもできます。' },
