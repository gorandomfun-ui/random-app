...
for timer in random-line@daily-auto-morning random-line@daily-auto-evening random-line@video-enrich random-line@trend-subjects random-line@web-embed random-line@like-pool random-line@pools random-status; do
