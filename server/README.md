...
- `run-line.sh <ligne>` : un passage d'une ligne, les réglages lus dans `.env.ingest`. Lignes : `daily-auto-morning`, `daily-auto-evening`, `video-enrich`, `trend-subjects`, `discovery`.
